  ...
  class Runner
    ...
    def parser
      @parser ||= OptionParser.new do |opts|
        ...
        opts.on("-v", "--asset_version VER", "The asset version to make")                { |ver|  @options[:asset_version] = ver }
        ...
        opts.on_tail('--version', "Show version")                            { puts "Asset Packager #{VERSION}"; exit }
      end
    end
    ...
    def run
      ...
      when 'deploy'
        Palmade::AssetPackager.deploy @options, @arguments
      else
